...
(function () {
  ...
  var c = BMapLib.InfoBox = function (f, e, d) {
    ...
    this._opts.closeIconWidth = d.closeIconWidth || "50px";
  ...
  c.prototype.getOffset = function () {
    ...
    _getCloseIcon: function () {
      ...
      var d = `<span style="position:absolute;right:0px;cursor:pointer;margin:${this._opts
        .closeIconMargin} "> ${this._opts.closeIconUrl || '关闭'} </span>`
      return d
    },
