...
<script>
import AppWaveBall from '_c/AppWaveBall'
import AppBruce from '_c/AppBruce'
export default {
  name: 'AapComponents',
  components: {
    AppWaveBall,
...
.aapComponents {
  ...
  .article {
    ...
    article {
      padding: 0 20px;
      background: linear-gradient(to right top, #FF6566 50%, #f0f0f0 50%) no-repeat;
